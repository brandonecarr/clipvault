    ...
    return (
      <main className="flex min-h-screen flex-col items-center justify-center bg-[#F8F9FA] px-6">
        <div className="w-full max-w-sm text-center">
          <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-[#00CEC9]/10">
    ...
    <main className="flex min-h-screen flex-col items-center justify-center bg-[#F8F9FA] px-6">
      <div className="w-full max-w-sm">
        ...
        <div className="mb-8 flex flex-col items-center text-center">
          ...
          <p className="mt-1 text-sm text-[#636E72]">Start saving videos for free</p>
        </div>
        ...
        <div className="rounded-2xl bg-white p-8 shadow-sm">
          ...
          <button
            ...
            className="mb-5 flex w-full items-center justify-center gap-3 rounded-xl border border-[#E0E0E0] bg-white py-3 text-sm font-medium text-[#2D3436] transition hover:bg-gray-50 disabled:opacity-60"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label htmlFor="password" className="mb-1.5 block text-xs font-medium text-[#636E72]">
                Password
              </label>
              <input
                id="password"
